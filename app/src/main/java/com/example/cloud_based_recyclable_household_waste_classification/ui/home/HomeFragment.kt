...
class HomeFragment : Fragment() {
    ...
    companion object {
        ...
        private const val REQUIRED_PERMISSION_WRITE_EXTERNAL_STORAGE =
            Manifest.permission.WRITE_EXTERNAL_STORAGE
        private const val REQUIRED_PERMISSION_READ_EXTERNAL_STORAGE =
            Manifest.permission.READ_EXTERNAL_STORAGE
        private const val REQUIRED_PERMISSION_READ_MEDIA_IMAGES =
            Manifest.permission.READ_MEDIA_IMAGES
        private const val REQUIRED_PERMISSION_ACCESS_FINE_LOCATION =
            Manifest.permission.ACCESS_FINE_LOCATION
        private const val REQUIRED_PERMISSION_ACCESS_COARSE_LOCATION =
    ...
    private val requestPermissionLauncher =
        registerForActivityResult(
            ...
            if (permissions[REQUIRED_PERMISSION_READ_MEDIA_IMAGES] == true) {
                Toast.makeText(
                    requireContext(),
                    "Read Media Images permission granted",
                    Toast.LENGTH_SHORT
                ).show()
            } else {
                Toast.makeText(requireContext(), "Read Media Images denied", Toast.LENGTH_SHORT)
                    .show()
            }
            ...
            if (permissions[REQUIRED_PERMISSION_ACCESS_FINE_LOCATION] == true) {
                ...
                Toast.makeText(requireContext(), "Access fine location denied", Toast.LENGTH_SHORT)
                    .show()
            }
    ...
    private fun allPermissionsGranted(): Boolean {
        ...
        val storagePermission = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            ContextCompat.checkSelfPermission(
                requireContext(),
                REQUIRED_PERMISSION_WRITE_EXTERNAL_STORAGE
            ) == PackageManager.PERMISSION_GRANTED ||
                    ContextCompat.checkSelfPermission(
                        requireContext(),
                        REQUIRED_PERMISSION_READ_EXTERNAL_STORAGE
                    ) == PackageManager.PERMISSION_GRANTED
        }
        val readMediaImages = ContextCompat.checkSelfPermission(
            requireContext(),
            REQUIRED_PERMISSION_READ_MEDIA_IMAGES
        ) == PackageManager.PERMISSION_GRANTED
...
//            ViewModelProvider(this).get(HomeViewModel::class.java)
            ...
            if (isSuccess == true) {
                ...
                viewModel.classificationResult.observe(viewLifecycleOwner) { result ->
                    ...
                    result?.let {
                        ...
                        intent.putExtra(
                            DetailActivity.KEY_SOURCE,
                            DetailActivity.SOURCE_HOME_FRAGMENT
                        )
    ...
    private fun playAnimation() {
        ...
        val titleText =
            ObjectAnimator.ofFloat(binding.textViewClassifyOrderTitle, View.ALPHA, 1f)
                .setDuration(400)

        val subTitleText =
            ObjectAnimator.ofFloat(binding.textViewClassifyOrderSubtitle, View.ALPHA, 1f)
                .setDuration(400)
